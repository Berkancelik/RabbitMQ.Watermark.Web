...
namespace RabbitMQ.Watermark.Web.BackgroundServices
{
    public class ImageWatermarkProcessBackgroundService : BackgroundService
    {
        ...
        private readonly ProductImageCreatedEvent productImageCreatedEvent;

        public ImageWatermarkProcessBackgroundService(ProductImageCreatedEvent productImageCreatedEvent)
        {
            this.productImageCreatedEvent = productImageCreatedEvent;
        }
